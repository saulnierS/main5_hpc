...
plt.ylabel('time (ms)')
plt.title('Evolution of the execution time of mergeSmall_k \n in relation to threads number')
...
plt.legend(['sequential code','mergeBig_k'], loc='best')
plt.xlabel('size M')
plt.ylabel('time (ms)')
plt.title('Evolution of the execution time of mergeBig_k and the sequential code \n in relation to the number of elements to be merged')
...
plt.legend(['without stream','with stream'], loc='best')
plt.xlabel('size M')
plt.ylabel('time (ms)')
plt.title('Evolution of execution of sort with and without stream \n in relation to the number of elements to sorte')
...
plt.plot(size_question3_s,time_question3_s,"o:")
plt.ylim(0,7000)
plt.legend(['mergeBatches','merge sort','sort without optimization'], loc='best')
plt.xlabel('size M')
plt.ylabel('time (ms)')
plt.title('Evolution of execution time of mergeBatches and other sort\n in relation to the number of elements to sort')
